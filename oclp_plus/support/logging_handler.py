...
class InitializeLoggingSupport:
    ...
    def __init__(self, global_constants: constants.Constants) -> None:
        ...
        self.log_filename: str  = f"OCLP-Plus_{self.constants.patcher_version}_{log_time}.log"
    ...
    def _clean_prior_version_logs(self) -> None:
        ...
        for path in paths:
            for file in path.glob("OCLP-Plus*"):
                if not file.is_file():
                    continue
    ...
    def _start_logging(self):
        ...
        str_msg = f"# OCLP-Plus ({self.constants.patcher_version}) #"
        str_len = len(str_msg)
    ...
    def _implement_custom_traceback_handler(self) -> None:
        ...
        def custom_excepthook(type, value, tb) -> None:
            ...
            error_msg = f"OCLP-Plus encountered the following internal error:\n\n"
