...
class UpdateFrame(wx.Frame):
    ...
    def __init__(self, parent: wx.Frame, title: str, global_constants: constants.Constants, screen_location: wx.Point, url: str = "", version_label: str = "") -> None:
        ...
        if download_obj.download_complete is False:
            ...
            wx.MessageBox("Failed to download update. If you continue to have this issue, please manually download OCLP-Plus off Github", "Critical Error!", wx.OK | wx.ICON_ERROR)
            sys.exit(1)
    ...
    def _launch_update(self) -> None:
        ...
        """
        logging.info("Launching update: '/Library/Application Support/Dortania/OCLP-Plus.app'")
        subprocess.Popen(["/Library/Application Support/Dortania/OCLP-Plus.app/Contents/MacOS/OCLP-Plus", "--update_installed"])
