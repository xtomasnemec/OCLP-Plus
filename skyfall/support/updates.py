"""
updates.py: Check for Skyfall binary updates
...
REPO_LATEST_RELEASE_URL: str = "https://api.github.com/repos/xtomasnemec/Skyfall/releases/latest"
...
class CheckBinaryUpdates:
    ...
    def check_binary_updates(self) -> Optional[dict]:
        """
        Check if any updates are available for the Skyfall binary
        ...
        for asset in data_set["assets"]:
            ...
            if asset["name"] == "Skyfall.pkg":
                self.latest_details = {
                    "Name": asset["name"],
                    "Version": latest_remote_version,
                    "Link": asset["browser_download_url"],
                    "Github Link": f"https://github.com/xtomasnemec/Skyfall/releases/{latest_remote_version}",
                }
                return self.latest_details
