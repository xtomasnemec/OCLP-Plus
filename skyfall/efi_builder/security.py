...
class BuildSecurity:
    ...
    def _build(self) -> None:
        ...
        if self.constants.sip_status is False or self.constants.custom_sip_value:
            ...
            # Adds AutoPkgInstaller for Automatic Skyfall installation
        ...
        if smbios_data.smbios_dictionary[self.model]["Max OS Supported"] < os_data.os_data.sonoma or amfipass_eligible:
