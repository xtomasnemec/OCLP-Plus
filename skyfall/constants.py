...
class Constants:
    def __init__(self) -> None:
        # Patcher Versioning
        self.patcher_version:                 str = "3.3.0"  # Skyfall
        ...
        self.repo_link:                       str = "https://github.com/xtomasnemec/Skyfall"
        self.installer_pkg_url:               str = f"{self.repo_link}/releases/download/{self.patcher_version}/AutoPkg-Assets.pkg"
        self.installer_pkg_url_nightly:       str = "http://nightly.link/xtomasnemec/Skyfall/workflows/build-app-wxpython/main/AutoPkg-Assets.pkg.zip"
        ...
        self.allow_untested_root_patches = False  # Allow untested root patches (ie. patches that have not been tested on the current OS version, but have been tested on other versions)
    ...
    def auto_patch_launch_agent_path(self):
        return self.launch_services_path / Path("com.xtomasnemec.skyfall.auto-patch.plist")

    @property
    def rsr_monitor_launch_daemon_path(self):
        return self.launch_services_path / Path("com.xtomasnemec.skyfall.rsr-monitor.plist")

    @property
    def update_launch_daemon_path(self):
        return self.launch_services_path / Path("com.xtomasnemec.skyfall.macos-update.plist")

    @property
    def kdk_launch_daemon_path(self):
        return self.launch_services_path / Path("com.xtomasnemec.skyfall.os-caching.plist")
    ...
    def oclp_helper_path(self):
        return self.payload_path / Path("Tools/Skyfall.app/Contents/MacOS/OpenCore-Patcher")
