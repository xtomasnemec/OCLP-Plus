...
class GenerateMenubar:
    ...
    def generate(self) -> wx.MenuBar:
        ...
        aboutItem = fileMenu.Append(wx.ID_ABOUT, "&About Skyfall")
...
class CheckProperties:
    ...
    def host_psp_version(self) -> packaging.version.Version:
        """
        Grab PatcherSupportPkg version from Skyfall.plist
        """
        oclp_plist_path = "/System/Library/CoreServices/Skyfall.plist"
