...
class UpdateFrame(wx.Frame):
    ...
    def __init__(self, parent: wx.Frame, title: str, global_constants: constants.Constants, screen_location: wx.Point, url: str = "", version_label: str = "") -> None:
        ...
        self.pkg_download_path = self.constants.payload_path / "Skyfall.pkg"
        ...
        def _fetch_update() -> None:
            ...
            file_name = "Skyfall.pkg.zip" if url.endswith(".zip") else "Skyfall.pkg"
        ...
        gui_download.DownloadFrame(
            ...
            item_name=f"Skyfall {version_label}",
        ...
        if download_obj.download_complete is False:
            ...
            wx.MessageBox("Failed to download update. If you continue to have this issue, please manually download Skyfall off Github", "Critical Error!", wx.OK | wx.ICON_ERROR)
            sys.exit(1)
        ...
        installed_path_label = wx.StaticText(self.frame, label='/Library/Application Support/xtomasnemec/Skyfall.app', pos=(-1, installed_label.GetPosition().y + 20))
    ...
    def _extract_update(self) -> None:
        ...
        result = subprocess.run(
            ["/usr/bin/ditto", "-xk", str(self.constants.payload_path / "Skyfall.pkg.zip"), str(self.constants.payload_path)], capture_output=True
        )
    ...
    def _install_update(self) -> None:
        ...
        if result.returncode != 0:
            ...
            if "User cancelled" in result.stderr.decode("utf-8"):
                ...
                wx.CallAfter(wx.MessageBox, f"Failed to install update. Please try installing the Skyfall.pkg manually or download from GitHub", "Critical Error!", wx.OK | wx.ICON_ERROR)
            wx.CallAfter(sys.exit, 1)
    ...
    def _launch_update(self) -> None:
        ...
        """
        logging.info("Launching update: '/Library/Application Support/xtomasnemec/Skyfall.app'")
        subprocess.Popen(["/Library/Application Support/xtomasnemec/Skyfall.app/Contents/MacOS/Skyfall", "--update_installed"])
