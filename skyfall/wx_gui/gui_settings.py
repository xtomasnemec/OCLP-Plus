...
"""
    ...
    def on_nightly(self, event: wx.Event) -> None:
        ...
        result = network_handler.NetworkUtilities().get("https://api.github.com/repos/YBronst/Skyfall/branches")
        ...
        gui_update.UpdateFrame(
            ...
            global_constants=self.constants,
            screen_location=self.parent.GetPosition(),
            url=f"https://nightly.link/YBronst/Skyfall/workflows/build-app-wxpython/{branch}/Skyfall.pkg.zip",
