...
class InstallAutomaticPatchingServices:
    ...
    def install_auto_patcher_launch_agent(self, kdk_caching_needed: bool = False):
        ...
        services = {
            self.constants.auto_patch_launch_agent_path:        "/Library/LaunchAgents/com.xtomasnemec.skyfall.auto-patch.plist",
            self.constants.update_launch_daemon_path:           "/Library/LaunchDaemons/com.xtomasnemec.skyfall.macos-update.plist",
            **({ self.constants.rsr_monitor_launch_daemon_path: "/Library/LaunchDaemons/com.xtomasnemec.skyfall.rsr-monitor.plist" } if self._create_rsr_monitor_daemon() else {}),
            **({ self.constants.kdk_launch_daemon_path:         "/Library/LaunchDaemons/com.xtomasnemec.skyfall.os-caching.plist" } if kdk_caching_needed is True else {} ),
        }
